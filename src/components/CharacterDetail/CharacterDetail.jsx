...
import {NavigationArrow, ArrowUp, ArrowLeft} from "@phosphor-icons/react";
...
function CharacterDetail({
    ...
    return <div className={styles["class-details"]}>
        <div className={styles["page-navigation"]}>
            ...
            to="/overview"
            >
            <ArrowLeft fill='var(--accent-color)' size={32}/>
        </InAppNavigation>

            <InAppNavigation
                onClick={() => setPageNavigationOpen(!pageNavigationOpen)}
            >
                <NavigationArrow fill='var(--accent-color)' size={32}/>
            </InAppNavigation>
    </div>
